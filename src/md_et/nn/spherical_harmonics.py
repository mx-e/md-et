...
def get_spherical_harmonics(
    ...
    sh = _spherical_harmonics(l_max, x[..., 0], x[..., 1], x[..., 2])
...
def _spherical_harmonics(
    lmax: int, x: th.Tensor, y: th.Tensor, z: th.Tensor
) -> th.Tensor:  # noqa: C901, PLR0911, PLR0915
    sh_0_0 = th.ones_like(x)
    if lmax == 0:
        return th.stack(
            [
                sh_0_0,
    ...
    if lmax == 1:
        return th.stack([sh_0_0, sh_1_0, sh_1_1, sh_1_2], dim=-1)
